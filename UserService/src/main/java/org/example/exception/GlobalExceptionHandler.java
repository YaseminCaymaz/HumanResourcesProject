...
public class GlobalExceptionHandler {
    ...
    @ResponseBody
    public ResponseEntity<ErrorMessage> userServiceHandler(UserServiceException userServiceException){
        return new ResponseEntity<>(createErrorMessage(userServiceException,userServiceException.getErrorType()),
                userServiceException.getErrorType().getHttpStatus());
    }
